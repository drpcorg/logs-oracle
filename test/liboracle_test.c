...
var suite = []Log{
        Log{BlockNumber: 0, Address: addresses[2], Topics: [4]Hash{Hash{},
Hash{}, Hash{}, Hash{}}}, Log{BlockNumber: 0, Address: addresses[2], Topics:
[4]Hash{Hash{}, Hash{}, Hash{}, Hash{}}}, Log{BlockNumber: 0, Address:
addresses[6], Topics: [4]Hash{topics[9], topics[0], topics[2], topics[2]}},

        Log{BlockNumber: 3, Address: addresses[8], Topics: [4]Hash{Hash{},
Hash{}, Hash{}, Hash{}}}, Log{BlockNumber: 3, Address: addresses[2], Topics:
[4]Hash{topics[9], Hash{}, Hash{}, Hash{}}}, Log{BlockNumber: 3, Address:
addresses[8], Topics: [4]Hash{topics[5], topics[8], Hash{}, Hash{}}},
        Log{BlockNumber: 3, Address: addresses[8], Topics: [4]Hash{Hash{},
Hash{}, Hash{}, Hash{}}}, Log{BlockNumber: 3, Address: addresses[6], Topics:
[4]Hash{topics[5], topics[7], Hash{}, Hash{}}},

        Log{BlockNumber: 4, Address: addresses[1], Topics: [4]Hash{Hash{},
Hash{}, Hash{}, Hash{}}}, Log{BlockNumber: 4, Address: addresses[9], Topics:
[4]Hash{topics[8], topics[7], topics[3], Hash{}}}, Log{BlockNumber: 4, Address:
addresses[1], Topics: [4]Hash{topics[0], topics[3], topics[5], topics[4]}},
        Log{BlockNumber: 4, Address: addresses[2], Topics: [4]Hash{topics[2],
topics[1], topics[0], topics[7]}},

        Log{BlockNumber: 5, Address: addresses[7], Topics: [4]Hash{topics[3],
topics[5], Hash{}, Hash{}}}, Log{BlockNumber: 5, Address: addresses[1], Topics:
[4]Hash{topics[1], topics[2], topics[9], Hash{}}}, Log{BlockNumber: 5, Address:
addresses[1], Topics: [4]Hash{topics[0], topics[2], topics[3], topics[8]}},
        Log{BlockNumber: 5, Address: addresses[3], Topics: [4]Hash{topics[2],
Hash{}, Hash{}, Hash{}}}, Log{BlockNumber: 5, Address: addresses[6], Topics:
[4]Hash{Hash{}, Hash{}, Hash{}, Hash{}}}, Log{BlockNumber: 5, Address:
addresses[0], Topics: [4]Hash{Hash{}, Hash{}, Hash{}, Hash{}}}, Log{BlockNumber:
5, Address: addresses[4], Topics: [4]Hash{topics[4], topics[2], Hash{},
Hash{}}},

        Log{BlockNumber: 6, Address: addresses[4], Topics: [4]Hash{topics[9],
topics[8], Hash{}, Hash{}}},
}
...
func TestQuery(t *testing.T) {
        ...
        // Full scan
        query(20, Query{FromBlock: 0, ToBlock: 6, Addresses: []Address{},
Topics: [][]Hash{}})

        // Segment too large
        query(20, Query{FromBlock: 0, ToBlock: 42, Addresses: []Address{},
Topics: [][]Hash{}})

        // One block
        query(1, Query{FromBlock: 6, ToBlock: 6, Addresses: []Address{}, Topics:
[][]Hash{}}) query(7, Query{FromBlock: 5, ToBlock: 5, Addresses: []Address{},
Topics: [][]Hash{}})

        // Correct segment
        query(9, Query{FromBlock: 2, ToBlock: 4, Addresses: []Address{}, Topics:
[][]Hash{}})
