...
final class constants$0 {
    ...
    static final FunctionDescriptor rcl_query_alloc$FUNC = FunctionDescriptor.of(Constants$root.C_INT$LAYOUT,
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_LONG_LONG$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle rcl_query_alloc$MH = RuntimeHelper.downcallHandle(
        "rcl_query_alloc",
        constants$0.rcl_query_alloc$FUNC
    );
}
